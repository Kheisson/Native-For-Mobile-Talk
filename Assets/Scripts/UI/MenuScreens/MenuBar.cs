...
namespace UIToolkitDemo
{
    ...
    public class MenuBar : MenuScreen
    {
        ...
        const string k_CharSelectButton = "player_profile_button";
        ...
        const string k_CharIcon = "player_profile_image";
        ...
        protected override void SetVisualElements()
        {
            ...
            m_CharSelectButton = m_Root.Q<Button>(k_CharSelectButton);

            m_MenuMarker = m_Root.Q(k_MenuMarker);
            m_CharImage = m_Root.Q<VisualElement>(k_CharIcon);
        ...
        protected override void RegisterButtonCallbacks()
        {
            ...
            m_CharSelectButton?.RegisterCallback<ClickEvent>(ShowCharSelectScreen);
        ...
        public void ShowCharSelectScreen(ClickEvent evt)
        {
            Debug.Log("ImagePicker | ShowCharSelectScreen");
            if (TryGetComponent(out ImagePicker imagePicker))
            {
                imagePicker.OpenImagePicker(HandleImagePickedSuccessfully);
            }
            else
            {
                var imageSelect = gameObject.AddComponent<ImagePicker>();
                imageSelect.OpenImagePicker(HandleImagePickedSuccessfully);
            }
        }
        ...
        void HandleImagePickedSuccessfully(Sprite sprite)
        {
            Debug.Log("ImagePicker | HandleImagePickedSuccessfully");
            m_CharImage.style.backgroundImage = new StyleBackground(sprite);
        }
